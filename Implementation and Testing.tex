...
Throughout the implementation process, the code was continuously tested this includes both unit testing (testing a single piece of code) and integration testing (testing multiple pieces of code work together as intended).
...
%%%%TODO:
- hyper parameters optimisation focusing on each hyper parameters
- testing section 
