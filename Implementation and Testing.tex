...
For quality assurance testing, several regression metrics were used.
These metrics evaluate the effectiveness of a model.

\subsection{The Testing Set}
The testing set was made up of the final 20\% of the unshuffled data.
Splitting the initial data into training and testing sets means that the model's generalization can be tested on the previously unseen testing data.
As the testing set was not shuffled, it provides a better perspective on how the models will perform on unseen future data as future data will be sequential.
