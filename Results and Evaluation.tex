...
The limited sample size meant that there was a limited amount of testing data available as the models required a minimum amount of samples for training.

% Implementation difficulties:
% - maintaining the temporal dependencies (several errors encountered from attempting to shift the data) (shuffling the data did not work)
% - implementing 5 models at once
% - run time of the models (especially during hyperparameter optimisation)
