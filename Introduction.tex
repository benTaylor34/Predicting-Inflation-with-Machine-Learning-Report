...
Instead, this project aims to understand which machine learning (ML) methods produce the best results when faced with this task and potentially find out why this is the case.
The main goal is for this project's results to ultimately contribute to the ongoing research into inflation forecasting and help clarify which ML methods may be most suitable. 
...
This project can be broken down into a list of objectives.
Objectives not only provide a path to follow to implement the project but also a way to evaluate the project's success post-completion.
