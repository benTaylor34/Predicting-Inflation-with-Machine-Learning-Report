...
one of the earliest uses of autoregressive models used for time series was in the 1920s from U.G.Yule\cite{5c7b6f25-ed11-3745-8118-935d66a8f3d3}.
...
Currently, there is an abundance of fresh machine learning papers constantly being produced in the field. \cite{8259424}
\begin{figure}[H]
    \centering
...
Additionally, in 2018 the number of articles released reached 100 per day and by the end of the year, summing to equal more than 33,000.
In the years since the number of articles released has continued to increase\cite{Dean2019TheDL}.
Naturally, to read this many articles is impossible, however, the sheer quantity bodes well for this project as it means there will be plenty of guidance on how best to select and develop our predictive models. 
